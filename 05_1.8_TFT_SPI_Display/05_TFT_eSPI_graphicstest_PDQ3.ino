...
#define DELAY_MSEC 500  // Delay mili seconds
...
void setup() {
  ...
  // Direct the ESP32-S3 to lock onto your custom pin mapping explicitly
  tft.init();          // initialize LCD
  tft.setRotation(0);  // Force initial orientation mapping registers
...
void loop(void) {
  ...
  Serial.println(F(__DATE__ " " __TIME__ " - Flash=0x"));
