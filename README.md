...
6. Go to **Tools >** Select the Configure Settings. Configure the following critical settings in the Tools menu:
   ...
   - **Partition Scheme**: `16M Flash (3MB APP/9.9MB FATFS)` for huge apps else leave it as standard. [See detail here](https://github.com/ooikk/Arduino-Documentation/blob/main/General_Info.md)
